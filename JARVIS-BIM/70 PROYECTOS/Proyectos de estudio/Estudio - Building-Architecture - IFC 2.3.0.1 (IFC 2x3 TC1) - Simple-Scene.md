...
proxies: 5
tamano_mb: 0.1
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Building-Architecture.ifc"
...
# Estudio — Building-Architecture - IFC 2.3.0.1 (IFC 2x3 TC1) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Building-Architecture.ifc` · 0.1 MB · esquema **IFC2x3 (ISO/PAS 16739:2005)** → [[IFC - ISO 16739]]
...
| Elementos / tipos / espacios | 14 / 15 / 2 |
...
| [[Clases IFC principales#IfcFurnishingElement|IfcFurnishingElement]] | 1 |
...
- Materiales distintos: 9 → concrete_reinforced_in-situ, wood_mdf_plate, stone_sand-lime, gypsum_fiber-board_panel, composite_element_roof, virtual_spatial-zone, bulk-material_sand-coarse_generic, virtual_white, virtual_black
...
- ⚠️ 5 `IfcBuildingElementProxy` (36% de los elementos): mapeo de clases IFC deficiente en la exportación → [[Control de calidad de modelos BIM]].
