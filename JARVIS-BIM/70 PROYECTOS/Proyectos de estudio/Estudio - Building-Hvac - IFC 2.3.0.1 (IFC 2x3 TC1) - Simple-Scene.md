...
proxies: 3
tamano_mb: 0.1
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Building-Hvac.ifc"
...
# Estudio — Building-Hvac - IFC 2.3.0.1 (IFC 2x3 TC1) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Building-Hvac.ifc` · 0.1 MB · esquema **IFC2x3 (ISO/PAS 16739:2005)** → [[IFC - ISO 16739]]
...
| [[Clases IFC principales#IfcFlowTerminal|IfcFlowTerminal]] | 2 |
| [[Clases IFC principales#IfcFlowSegment|IfcFlowSegment]] | 1 |
...
- ⚠️ 3 `IfcBuildingElementProxy` (50% de los elementos): mapeo de clases IFC deficiente en la exportación → [[Control de calidad de modelos BIM]].
