...
proxies: 1
tamano_mb: 0.0
archivo: "02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/basic-geometric-shape/brep-model/brep-model.ifc"
...
> Modelo: `02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/basic-geometric-shape/brep-model/brep-model.ifc` · 0.0 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]

## 1. Ficha del modelo
| Campo | Valor |
|---|---|
| Proyecto (IfcProject) | proxy with brep  |
