...
esquema: IFC2X3
disciplina: MIXTO
elementos_totales: 77
pisos: 0
espacios: 0
proxies: 73
tamano_mb: 0.1
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Infra-Rail.ifc"
...
# Estudio — Infra-Rail - IFC 2.3.0.1 (IFC 2x3 TC1) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Infra-Rail.ifc` · 0.1 MB · esquema **IFC2x3 (ISO/PAS 16739:2005)** → [[IFC - ISO 16739]]
...
| Autor / organización | — / — |
| Fecha del archivo | 2026-06-23T11:53:16 |
...
| Elementos / tipos / espacios | 77 / 4 / 0 |
...
| Clase | Cantidad |
|---|---|
| [[Clases IFC principales#IfcBuildingElementProxy|IfcBuildingElementProxy]] | 73 |
| `IfcElementAssembly` | 4 |
| [[Clases IFC principales#IfcBuilding|IfcBuilding]] | 2 |
...
- Materiales distintos: 4 → metal_hot-rolled-steel, bulk-material_ballast_generic, wood-generic, virtual_black
...
- ⚠️ 73 `IfcBuildingElementProxy` (95% de los elementos): mapeo de clases IFC deficiente en la exportación → [[Control de calidad de modelos BIM]].
