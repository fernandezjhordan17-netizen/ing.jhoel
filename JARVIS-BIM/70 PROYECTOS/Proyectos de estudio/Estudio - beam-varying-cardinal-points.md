...
proxies: 0
tamano_mb: 0.0
archivo: "02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/building-elements/beam-varying-cardinal-points/beam-varying-cardinal-points.ifc"
software_origen: "redacted - redacted - 3.14159 · redacted"
generado: 2026-09-24
tags: [proyecto, estudio, ifc]
---

# Estudio — beam-varying-cardinal-points

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/building-elements/beam-varying-cardinal-points/beam-varying-cardinal-points.ifc` · 0.0 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]
...
| Elementos / tipos / espacios | 4 / 1 / 0 |
...
| Clase | Cantidad |
|---|---|
| [[Clases IFC principales#IfcBeam|IfcBeam]] | 4 |
| [[Clases IFC principales#IfcBuilding|IfcBuilding]] | 1 |

**Mezcla por disciplina**: ARQ 0 · EST 4 · MEP 0 · INFRA 0
