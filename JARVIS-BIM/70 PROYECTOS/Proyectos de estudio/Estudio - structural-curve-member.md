...
proxies: 0
tamano_mb: 0.0
archivo: "02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/structural-analysis-model/structural-curve-member/structural-curve-member.ifc"
software_origen: "redacted - redacted - 3.14159 · redacted"
generado: 2026-09-24
tags: [proyecto, estudio, ifc]
---

# Estudio — structural-curve-member

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/structural-analysis-model/structural-curve-member/structural-curve-member.ifc` · 0.0 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]
...
| Clase | Cantidad |
|---|---|
| `IfcStructuralPointReaction` | 6 |
| `IfcStructuralPointConnection` | 4 |
| `IfcStructuralCurveReaction` | 3 |
| `IfcStructuralCurveMember` | 3 |
| `IfcStructuralCurveAction` | 1 |

**Mezcla por disciplina**: ARQ 0 · EST 3 · MEP 0 · INFRA 0

## 4. Información (datos) → [[LOIN - Nivel de Informacion Necesaria]]
- Materiales distintos: 1 → ASTM A36
