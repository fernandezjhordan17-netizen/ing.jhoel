...
proxies: 73
tamano_mb: 0.2
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.0.2.1 (IFC 4 ADD2 TC1)/Simple-Scene/Infra-Rail.ifc"
...
# Estudio — Infra-Rail - IFC 4.0.2.1 (IFC 4 ADD2 TC1) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.0.2.1 (IFC 4 ADD2 TC1)/Simple-Scene/Infra-Rail.ifc` · 0.2 MB · esquema **IFC4 (ISO 16739-1:2018)** → [[IFC - ISO 16739]]
...
| Elementos / tipos / espacios | 77 / 6 / 0 |
