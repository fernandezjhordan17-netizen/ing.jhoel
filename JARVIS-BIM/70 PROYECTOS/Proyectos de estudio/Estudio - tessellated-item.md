...
proxies: 1
tamano_mb: 0.0
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.0.2.1 (IFC 4 ADD2 TC1)/ISO Spec - ReferenceView_V1.2/tessellated-item.ifc"
software_origen: "buildingSMART International - IFC text editor - 1.0.0 · IFC text editor"
generado: 2026-09-24
tags: [proyecto, estudio, ifc]
---

# Estudio — tessellated-item

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.0.2.1 (IFC 4 ADD2 TC1)/ISO Spec - ReferenceView_V1.2/tessellated-item.ifc` · 0.0 MB · esquema **IFC4 (ISO 16739-1:2018)** → [[IFC - ISO 16739]]

## 1. Ficha del modelo
| Campo | Valor |
|---|---|
| Proyecto (IfcProject) | proxy with tessellation  |
| Software de origen | buildingSMART International - IFC text editor - 1.0.0 · IFC text editor |
| Autor / organización | Thomas Liebich / buildingSMART International |
| Fecha del archivo | 2012-07-04T18:00:00 |
