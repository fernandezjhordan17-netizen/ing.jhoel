...
proxies: 0
tamano_mb: 0.0
archivo: "02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/tessellated-shape-with-style/tessellation-with-image-texture/tessellation-with-image-texture.ifc"
software_origen: "redacted - redacted - 3.14159 · redacted"
generado: 2026-09-24
tags: [proyecto, estudio, ifc]
---

# Estudio — tessellation-with-image-texture

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/tessellated-shape-with-style/tessellation-with-image-texture/tessellation-with-image-texture.ifc` · 0.0 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]
...
| Autor / organización | — / — |
| Fecha del archivo | 2016-05-06T03:47:49 |
