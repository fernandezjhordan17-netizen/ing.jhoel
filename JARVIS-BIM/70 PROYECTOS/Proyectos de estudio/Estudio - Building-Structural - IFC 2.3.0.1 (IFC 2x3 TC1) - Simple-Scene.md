...
esquema: IFC2X3
disciplina: ARQ+EST
elementos_totales: 17
pisos: 1
espacios: 0
proxies: 5
tamano_mb: 0.1
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Building-Structural.ifc"
...
# Estudio — Building-Structural - IFC 2.3.0.1 (IFC 2x3 TC1) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Building-Structural.ifc` · 0.1 MB · esquema **IFC2x3 (ISO/PAS 16739:2005)** → [[IFC - ISO 16739]]
...
| Autor / organización | — / — |
| Fecha del archivo | 2026-06-23T11:53:12 |
...
| Elementos / tipos / espacios | 17 / 9 / 0 |
...
**Mezcla por disciplina**: ARQ 5 · EST 7 · MEP 0 · INFRA 0

## 4. Información (datos) → [[LOIN - Nivel de Informacion Necesaria]]
- Materiales distintos: 6 → concrete_reinforced_in-situ, stone_sand-lime, wood_spruce_beam, metal_steel-galvanized, virtual_white, virtual_black
- Conjuntos de cantidades (Qto): 10
- Clasificaciones: CCI Construction
- Property Sets más frecuentes:

## 5. Diagnóstico de calidad → [[Control de calidad de modelos BIM]]
- ⚠️ 5 `IfcBuildingElementProxy` (29% de los elementos): mapeo de clases IFC deficiente en la exportación → [[Control de calidad de modelos BIM]].
...
- ✅ 10 conjuntos de cantidades (Qto) útiles para metrados → [[BIM 5D - Costos y metrados]].
