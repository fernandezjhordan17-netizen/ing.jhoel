...
esquema: IFC4X3
disciplina: INFRA
elementos_totales: 81
pisos: 0
espacios: 0
proxies: 1
tamano_mb: 0.3
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.3.2.0 (IFC 4.3 ADD2)/Simple-Scene/Infra-Road.ifc"
...
# Estudio — Infra-Road - IFC 4.3.2.0 (IFC 4.3 ADD2) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.3.2.0 (IFC 4.3 ADD2)/Simple-Scene/Infra-Road.ifc` · 0.3 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]
...
| Elementos / tipos / espacios | 81 / 8 / 0 |
...
|---|---|
| `IfcRoadPart` | 26 |
| `IfcSurfaceFeature` | 20 |
| `IfcCourse` | 16 |
| `IfcEarthworksFill` | 16 |
...
**Mezcla por disciplina**: ARQ 0 · EST 0 · MEP 0 · INFRA 37

## 4. Información (datos) → [[LOIN - Nivel de Informacion Necesaria]]
- Materiales distintos: 6 → bitumen_dbm_generic, bitumen_asphalt_generic, bulk-material_gravel_generic, bulk-material_crushed-stone_generic, plastic_thermoplastic-road-marking-paint, virtual_black
...
- ⚠️ 20 elementos sin piso/espacio contenedor → revisar la estructura espacial ([[IFC - Estructura del esquema]]).
