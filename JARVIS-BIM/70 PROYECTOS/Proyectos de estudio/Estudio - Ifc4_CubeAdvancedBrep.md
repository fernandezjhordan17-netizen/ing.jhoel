...
proxies: 1
tamano_mb: 0.0
archivo: "02_PROYECTOS_BIM/IfcSampleFiles/Ifc4_CubeAdvancedBrep.ifc"
software_origen: "ssiIFC - Grasshopper Plug-in by Geometry Gym Pty Ltd"
generado: 2026-09-24
tags: [proyecto, estudio, ifc]
---

# Estudio — Ifc4_CubeAdvancedBrep

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/IfcSampleFiles/Ifc4_CubeAdvancedBrep.ifc` · 0.0 MB · esquema **IFC4 (ISO 16739-1:2018)** → [[IFC - ISO 16739]]

## 1. Ficha del modelo
| Campo | Valor |
|---|---|
| Proyecto (IfcProject) | Grasshopper Project — Grasshopper Project |
| Software de origen | ssiIFC - Grasshopper Plug-in by Geometry Gym Pty Ltd |
