...
esquema: IFC4X3
disciplina: EST
elementos_totales: 36
pisos: 0
espacios: 0
proxies: 0
tamano_mb: 0.0
archivo: "02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/building-elements/reinforcing-assembly/reinforcing-assembly.ifc"
software_origen: "redacted - redacted - 3.14159 · redacted"
generado: 2026-09-24
tags: [proyecto, estudio, ifc]
---

# Estudio — reinforcing-assembly

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_IFC4.3_sample-models/models/building-elements/reinforcing-assembly/reinforcing-assembly.ifc` · 0.0 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]
...
| Elementos / tipos / espacios | 36 / 2 / 0 |
...
| Clase | Cantidad |
|---|---|
| [[Clases IFC principales#IfcReinforcingBar|IfcReinforcingBar]] | 34 |
| [[Clases IFC principales#IfcBeam|IfcBeam]] | 1 |
...
- Materiales distintos: 2 → ReinforcingSteel, Concrete
