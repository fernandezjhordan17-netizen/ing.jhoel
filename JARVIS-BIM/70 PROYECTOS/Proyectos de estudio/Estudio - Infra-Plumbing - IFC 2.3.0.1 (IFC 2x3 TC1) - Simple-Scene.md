...
proxies: 1
tamano_mb: 0.2
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Infra-Plumbing.ifc"
...
# Estudio — Infra-Plumbing - IFC 2.3.0.1 (IFC 2x3 TC1) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 2.3.0.1 (IFC 2x3 TC1)/Simple-Scene/Infra-Plumbing.ifc` · 0.2 MB · esquema **IFC2x3 (ISO/PAS 16739:2005)** → [[IFC - ISO 16739]]
...
| Elementos / tipos / espacios | 29 / 3 / 0 |
...
| Clase | Cantidad |
|---|---|
| [[Clases IFC principales#IfcFlowSegment|IfcFlowSegment]] | 24 |
...
**Mezcla por disciplina**: ARQ 0 · EST 0 · MEP 26 · INFRA 0
