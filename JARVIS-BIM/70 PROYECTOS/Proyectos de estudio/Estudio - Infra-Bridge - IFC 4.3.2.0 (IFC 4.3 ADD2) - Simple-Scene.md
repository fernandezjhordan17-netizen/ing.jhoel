...
proxies: 1
tamano_mb: 1.7
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.3.2.0 (IFC 4.3 ADD2)/Simple-Scene/Infra-Bridge.ifc"
...
# Estudio — Infra-Bridge - IFC 4.3.2.0 (IFC 4.3 ADD2) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.3.2.0 (IFC 4.3 ADD2)/Simple-Scene/Infra-Bridge.ifc` · 1.7 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]
...
| Elementos / tipos / espacios | 68 / 15 / 0 |
...
**Mezcla por disciplina**: ARQ 6 · EST 30 · MEP 0 · INFRA 7
