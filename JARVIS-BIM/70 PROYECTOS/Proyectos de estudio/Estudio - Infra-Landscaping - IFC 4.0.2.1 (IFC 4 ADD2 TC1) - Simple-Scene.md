...
proxies: 15
tamano_mb: 2.2
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.0.2.1 (IFC 4 ADD2 TC1)/Simple-Scene/Infra-Landscaping.ifc"
...
# Estudio — Infra-Landscaping - IFC 4.0.2.1 (IFC 4 ADD2 TC1) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.0.2.1 (IFC 4 ADD2 TC1)/Simple-Scene/Infra-Landscaping.ifc` · 2.2 MB · esquema **IFC4 (ISO 16739-1:2018)** → [[IFC - ISO 16739]]
...
| [[Clases IFC principales#IfcBuildingElementProxy|IfcBuildingElementProxy]] | 15 |
...
- ⚠️ 15 `IfcBuildingElementProxy` (14% de los elementos): mapeo de clases IFC deficiente en la exportación → [[Control de calidad de modelos BIM]].
