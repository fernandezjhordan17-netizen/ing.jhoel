...
proxies: 2
tamano_mb: 0.2
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.3.2.0 (IFC 4.3 ADD2)/Simple-Scene/Building-Structural.ifc"
...
# Estudio — Building-Structural - IFC 4.3.2.0 (IFC 4.3 ADD2) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.3.2.0 (IFC 4.3 ADD2)/Simple-Scene/Building-Structural.ifc` · 0.2 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]
...
- ⚠️ 2 `IfcBuildingElementProxy` (12% de los elementos): mapeo de clases IFC deficiente en la exportación → [[Control de calidad de modelos BIM]].
