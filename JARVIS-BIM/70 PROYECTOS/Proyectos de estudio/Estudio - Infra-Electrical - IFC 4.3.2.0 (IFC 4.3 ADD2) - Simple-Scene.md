...
esquema: IFC4X3
disciplina: MEP+INFRA
elementos_totales: 6
pisos: 0
espacios: 0
proxies: 1
tamano_mb: 0.1
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.3.2.0 (IFC 4.3 ADD2)/Simple-Scene/Infra-Electrical.ifc"
...
# Estudio — Infra-Electrical - IFC 4.3.2.0 (IFC 4.3 ADD2) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.3.2.0 (IFC 4.3 ADD2)/Simple-Scene/Infra-Electrical.ifc` · 0.1 MB · esquema **IFC 4.3 (ISO 16739-1:2024)** → [[IFC - ISO 16739]]
...
| Disciplina inferida | **MEP+INFRA** → [[Coordinacion BIM y deteccion de interferencias]] · [[BIM para infraestructura]] |
| Elementos / tipos / espacios | 6 / 5 / 0 |
...
| [[Clases IFC principales#IfcRoad|IfcRoad]] | 5 |
...
**Mezcla por disciplina**: ARQ 0 · EST 1 · MEP 3 · INFRA 8

## 4. Información (datos) → [[LOIN - Nivel de Informacion Necesaria]]
- Materiales distintos: 5 → metal_sheetmetal_generic, concrete_reinforced_prefab, cement_grout_generic, Default, virtual_black
...
- ⚠️ 1 `IfcBuildingElementProxy` (17% de los elementos): mapeo de clases IFC deficiente en la exportación → [[Control de calidad de modelos BIM]].
