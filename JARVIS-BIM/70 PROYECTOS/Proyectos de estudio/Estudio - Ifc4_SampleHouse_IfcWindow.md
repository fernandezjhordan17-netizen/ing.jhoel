...
proxies: 0
tamano_mb: 0.0
archivo: "02_PROYECTOS_BIM/IfcSampleFiles/Ifc4_SampleHouse_IfcWindow.ifc"
software_origen: "Ifc.Toolbox v3.9 - BIM Mars · Xbim File Processor version 4.0.0.0"
generado: 2026-09-24
tags: [proyecto, estudio, ifc]
---

# Estudio — Ifc4_SampleHouse_IfcWindow

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/IfcSampleFiles/Ifc4_SampleHouse_IfcWindow.ifc` · 0.0 MB · esquema **IFC4 (ISO 16739-1:2018)** → [[IFC - ISO 16739]]
...
- Materiales distintos: 2 → Window Frame, Glass
...
- Property Sets más frecuentes:
  ...
  - `Dimensions` × 6
  - `Pset_WindowCommon` × 4
  - `Pset_ManufacturerTypeInformation` × 4
  - `Phasing` × 4
  - `Graphics` × 2
