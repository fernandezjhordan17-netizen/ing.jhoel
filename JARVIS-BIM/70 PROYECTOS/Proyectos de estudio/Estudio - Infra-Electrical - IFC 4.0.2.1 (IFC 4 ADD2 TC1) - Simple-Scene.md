...
proxies: 1
tamano_mb: 0.1
archivo: "02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.0.2.1 (IFC 4 ADD2 TC1)/Simple-Scene/Infra-Electrical.ifc"
...
# Estudio — Infra-Electrical - IFC 4.0.2.1 (IFC 4 ADD2 TC1) - Simple-Scene

> [!info] Nota generada automáticamente por `scripts/03_ifc_a_obsidian.py`
> Modelo: `02_PROYECTOS_BIM/buildingSMART_Sample-Test-Files/IFC 4.0.2.1 (IFC 4 ADD2 TC1)/Simple-Scene/Infra-Electrical.ifc` · 0.1 MB · esquema **IFC4 (ISO 16739-1:2018)** → [[IFC - ISO 16739]]
...
| Disciplina inferida | **EST+MEP** → [[MOC Ingenieria Estructural]] · [[Coordinacion BIM y deteccion de interferencias]] |
...
| Clase | Cantidad |
|---|---|
| [[Clases IFC principales#IfcBuilding|IfcBuilding]] | 8 |
...
**Mezcla por disciplina**: ARQ 0 · EST 1 · MEP 3 · INFRA 0
