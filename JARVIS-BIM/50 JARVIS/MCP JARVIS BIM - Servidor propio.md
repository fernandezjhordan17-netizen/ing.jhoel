...
| Estructuras | `csi_estado`, `csi_leer_tabla`, `csi_derivas`, `csi_reacciones_base`, `csi_crear_espectro_e030`, `csi_crear_combinaciones_e060`, `csi_correr_analisis` | [[MCP CSI - ETABS SAP2000 SAFE]] |
...
2. ✅ `e060_*` y ✅ `ifc_metrados` (hecho). Siguiente: diagrama de interacción de columnas y cálculo de encofrado.
3. Verificación de U máx. de la [[EM.110 - Confort Termico y Luminico]] desde el modelo.
